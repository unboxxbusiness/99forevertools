...
import { AtSign, CaseSensitive, FileSignature, Loader2, Zap, Lightbulb, Briefcase } from 'lucide-react';
            ...
            <AccordionItem value="how-it-works">
                ...
                <AccordionContent className="pt-4 text-muted-foreground">
                    <ol className="list-decimal list-inside space-y-2">
                        <li>Enter the first name, last name, and domain of the person you're trying to contact.</li>
                        <li>Click the "Generate Emails" button.</li>
                        <li>The tool creates a list of common email address formats (e.g., f.last@domain.com, first.l@domain.com).</li>
                        <li>Copy the generated emails to test in your outreach tool or email client.</li>
                    </ol>
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="use-cases">
                ...
                <AccordionContent className="pt-4 text-muted-foreground">
                    <ul className="list-disc list-inside space-y-2">
                        <li><strong>Sales Outreach:</strong> Find the correct email address for potential leads when you only have their name and company.</li>
                        <li><strong>Business Development:</strong> Connect with potential partners by guessing their corporate email.</li>
                        <li><strong>Recruitment:</strong> Reach out directly to potential candidates for job openings.</li>
                        <li><strong>PR & Media:</strong> Find the contact information for journalists or bloggers at media outlets.</li>
                    </ul>
                </AccordionContent>
            </AccordionItem>
        </Accordion>
