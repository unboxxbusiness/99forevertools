...
import { Copy, Check, Link as LinkIcon, Info, Search, Lightbulb, Briefcase } from 'lucide-react';
            ...
            <AccordionItem value="how-it-works">
                ...
                <AccordionContent className="pt-4 text-muted-foreground">
                    <ol className="list-decimal list-inside space-y-2">
                        <li>Find your business's unique Google Place ID using the provided link to the official finder tool.</li>
                        <li>Paste your Place ID into the input field.</li>
                        <li>The tool instantly generates a direct link to the "Write a Review" page for your business.</li>
                        <li>Copy the link and share it with your happy customers.</li>
                    </ol>
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="use-cases">
                ...
                <AccordionContent className="pt-4 text-muted-foreground">
                    <ul className="list-disc list-inside space-y-2">
                        <li><strong>Post-Purchase Emails:</strong> Send an email to customers after a purchase, asking them to share their experience.</li>
                        <li><strong>On Receipts:</strong> Print the link (or a QR code of the link) on physical or digital receipts.</li>
                        <li><strong>Social Media:</strong> Share the link in a social media post, encouraging followers who are customers to leave a review.</li>
                        <li><strong>Customer Service Interactions:</strong> After a positive customer service chat, share the link and ask for a review.</li>
                    </ul>
                </AccordionContent>
            </AccordionItem>
        </Accordion>
